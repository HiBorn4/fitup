...
class _ExerciseResultPageState extends State<ExerciseResultPage> {
  ...
  void dispose() {
    _confettiController
        .dispose(); // Dispose of the ConfettiController when the widget is removed
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
            '${widget.exerciseName} Result'), // Set the app bar title with the exercise name
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ConfettiWidget(
              confettiController:
                  _confettiController, // Link the confetti controller
